...
def update_patient_information():
    ...
    print("update patient information through id : ")

    id = helper.get_input_string("enter patient id : ")  
    ...
    with open("data/patient.csv" ,mode="r", newline="") as csv_file:
        ...
        with open ("data/patient.csv", mode="w", newline="") as write_csv:
            writer = csv.DictWriter(write_csv, fieldnames=headers)
